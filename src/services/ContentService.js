...
class ContentService {
    ...
    onContentInfoRequested(data) {
        ...
        const contentData = { // запрос за контентом по id
            ...
            year: '2019',
            seasons: '2 сезона',
            about: 'Ведьмак Геральт, мутант и убийца чудовищ, на своей верной лошади по кличке Плотва путешествует по Континенту.',
            ...
            cast: ['Генри Кавилл', 'Фрейя Аллан', 'Аня Чалотра', 'Мими Дивени', 'Месия', 'Симсон', 'Имон Фэррен', 'МайАнна Бёринг', 'Ройс Пирресон', 'Имон Фаррен', 'Мими Дивени', 'Уилсон Раджу-Пухальте', 'Анна Шаффер', 'Махеш Джаду'],
            directors: ['Алик Сахаров', 'Шарлотта Брандстром', 'Алекс Гарсиа Лопес', 'Марк Йобст', 'Эдвард Базалгетт', 'Сара О’Горман', 'Гита Патель', 'Стивен Серджик'],
